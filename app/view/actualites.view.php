        ...
        <section id="contain2">
            <div id="tit">
                <div id="gauche1">
                    ...
                    <a href="produit.php?nom=La%20butineuse"> <button id="btn-1" tabindex="-1">En savoir plus</button> </a>
                </div>
                <div id="droite1"><img src="public/images/mockup/butineuse_vmaxou2.png" alt="Notre bière la Butineuse">
                </div>
            </div>
            </div>
        </section>
